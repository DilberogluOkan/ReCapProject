...
namespace Business.Concrete
{
    public class ColorManager : IColorService
    {
        ...
        {
            return new SuccessDataResult<List<Color>>(_colorDal.GetAll(),Messages.ListSucces);
        }

        public IDataResult<Color> GetById(int colorId)
        {
            return new SuccessDataResult<Color>( _colorDal.Get(p => p.ColorId == colorId), Messages.ListSucces);
        }
